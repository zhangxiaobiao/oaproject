...
<div class="table-operate ue-clear">
	<a href="/xiaozuxiangmu/index.php/Email/add" class="add">添加</a>
	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="name"><?php echo ($vo["from_name"]); ?></td>
                <td class="name"><?php echo ($vo["title"]); ?></td>
				<td class="file"><?php echo ($vo["filename"]); ?>
				<?php if($vo["hasfile"] == 1): ?><a href="#" class="download" data="<?php echo ($vo["id"]); ?>">【下载】</a><?php endif; ?>
				</td>
...
$(function () {
	$('.download').on('click', function(){
		...
		window.location.href = '/xiaozuxiangmu/index.php/Email/download/id/' + id;
	});
	$('.show').on('click', function(){
		...
		layer.open({
			...
			shade: 0,
			area: ['550px', '90%'],
			content: '/xiaozuxiangmu/index.php/Email/getContent/id/' + id,
			end: function () {
