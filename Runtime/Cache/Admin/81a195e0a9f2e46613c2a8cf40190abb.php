...
<div class="table-operate ue-clear">
	<a href="/xiaozuxiangmu/index.php/Doc/add" class="add">添加</a>
    <a href="javascript:;" id="btndel" class="del">删除</a>
    <a href="javascript:;" id="btnedit" class="edit">编辑</a>
    <a href="/xiaozuxiangmu/index.php/Doc/chart" class="count">统计</a>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="operate">
                	...
                	<a href ='javascript:;' class="view" data="<?php echo ($vo["id"]); ?>" data-title="<?php echo ($vo["title"]); ?>">查看</a>
					<?php if($vo['hasfile'] == 1): ?>|<a href="javascript:;" class="down" data="<?php echo ($vo["id"]); ?>">下载附件</a><?php endif; ?>
                </td>
...
<script type="text/javascript" src="/xiaozuxiangmu/Public/Admin/js/layer/layer.js"></script>
...
showRemind('input[type=text], textarea','placeholder');
	$(function(){
		$('.down').on('click', function(){
			...
			window.location.href = '/xiaozuxiangmu/index.php/Doc/download/id/' + id;
		});
		$('#btnedit').on('click', function(){
			var id = $(':checkbox:checked').val();
			window.location.href = '/xiaozuxiangmu/index.php/Doc/edit/id/' + id;
		});
		$('#btndel').on('click', function(){
			...
			window.location.href = '/xiaozuxiangmu/index.php/Doc/del/ids/' + ids;
		});
		$('.view').on('click',function(){
			...
			layer.open({
				...
				shade:0,
				area:['550px', '90%'],
				content:'/xiaozuxiangmu/index.php/Doc/content/id/' +docID
			});
		});
	});
</script>
