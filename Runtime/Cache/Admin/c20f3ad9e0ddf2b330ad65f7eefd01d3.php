...
<link rel="stylesheet" type="text/css" href="/xiaozuxiangmu/Public/Admin/css/jquery.dialog.css" />
<link rel="stylesheet" href="/xiaozuxiangmu/Public/Admin/css/index.css" />
...
<div id="container">
  ...
  <div id="bd">
    <div class="wrap ue-clear">
        ...
        <ul class="nav">
          ...
          <li class="agency">
            ...
            <ul class="subnav">
              ...
              <li><a href="javascript:;" date-src="<?php echo U('Dept/deptList');?>">部门列表</a></li>
      ...
      <div class="content">
        <iframe src="<?php echo U('Index/home');?>" name="iframe" id="iframe" width="100%" height="100%" frameborder="0"></iframe>
      </div>
    </div>
  </div>
...
<script type="text/javascript" src="/xiaozuxiangmu/Public/Admin/js/core.js"></script>
<script type="text/javascript" src="/xiaozuxiangmu/Public/Admin/js/jquery.dialog.js"></script>
<script type="text/javascript" src="/xiaozuxiangmu/Public/Admin/js/index.js"></script>
