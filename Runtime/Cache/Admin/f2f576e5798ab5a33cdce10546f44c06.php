	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<?php if($vo["hasfile"] == 1): ?><a href="#" data="<?php echo ($vo["id"]); ?>" class="download">下载</a><?php endif; ?>
				</td>
                ...
                <td class="status">
					<?php if($vo["isread"] == 0): ?><span style="color:green;">未读</span>
						<?php else: ?>
						<span style="color:red;">已读</span><?php endif; ?></td>
                <td class="operate">
                	<a href ="/xiaozuxiangmu/index.php/Email/del/id/<?php echo ($vo["id"]); ?>" class="del" data="<?php echo ($vo["id"]); ?>">删除</a>
                </td>
