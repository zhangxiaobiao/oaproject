...
<head>
	...
	<link rel="stylesheet" href="/xiaozuxiangmu/Public/Admin/css/login.css" />
	<title>移动办公自动化系统</title>
</head>
<body><form action="<?php echo U('index');?>" method="post">
	<div id="container">
		<div id="bd">
			<div class="login1">
                ...
                <div class="login-input">
                    ...
                    <p class="yzm ue-clear">
                        ...
                        <cite><img src="/xiaozuxiangmu/index.php/Public/captcha" onclick="this.src='/xiaozuxiangmu/index.php/Public/captcha/t/'+Math.random()"></cite>
                    </p>
                </div>
                <div class="login-btn ue-clear">
                	<a href="javascript:void(0)" class="btn" id="btnlogin">登录</a>
