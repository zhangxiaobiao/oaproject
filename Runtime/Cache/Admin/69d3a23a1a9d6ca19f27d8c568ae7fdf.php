...
<form action="/xiaozuxiangmu/index.php/Doc/addOk" method="post" enctype="multipart/form-data">
<div class="main">
    ...
    <p class="short-input ue-clear">
    	<label>内容：
			<script id="editor" type="text/plain" name="content" style="width:900px;height:300px;"></script></label>
